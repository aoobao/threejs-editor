...
Sidebar.Object = function (editor) {
	...
	*/
	...
	var objectName = new UI.Input().setWidth('150px').setFontSize('12px').setDisabled(true).onChange(function () {
	...
	var objectUserData = new UI.TextArea().setWidth('150px').setHeight('80px').setFontSize('12px')
		.setDisabled(true)
		.onChange(update);
	...
	var deleteRow = new UI.Row()

	var objectDelete = new UI.Button(strings.getKey('menubar/edit/delete'))
		.setWidth('100%')
		.setBackgroundColor('#F56C6C')
		.setColor('#fff')
		.onClick(function () {
			var object = editor.selected;
			...
			if (object.userData.isDevice) {
				editor.execute(new RemoveObjectCommand(editor, object));
			}

		});

	deleteRow.add(objectDelete)
