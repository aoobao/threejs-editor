...
var Editor = function () {
	...
	this.DEFAULT_CAMERA = new THREE.PerspectiveCamera(50, 1, 0.01, 50000000);
	this.DEFAULT_CAMERA.name = 'Camera';
	// this.DEFAULT_CAMERA.position.set(0, 5, 10);
	this.DEFAULT_CAMERA.position.set(94.1, 39.4, -154.6)

	// this.DEFAULT_CAMERA.position.set(606820.5991483959, 3345295.7507734355, 13.259425180062008)
	...
	// this.scene2.name = 'SceneBackground'
	// this.scene2.background = new THREE.Color(0xaaaaaa);
...
Editor.prototype = {
	...
	select: function (object) {
		...
		if (object && !!object.userData.disable) {
			object = null
		}

		if (object !== null) {
			if (object.userData && !object.userData.isDevice) {
